...
__all__ = [
    ...
    "E_FASTQ_MATE_PAIRING_FAILED",
    "E_ADAPTER_AMBIGUOUS",
    "E_UMI_DECLARED_BUT_NOT_FOUND",
    "E_READ_LENGTH_NO_PERIODICITY",
    "E_RNA_RIBO_PAIRING_INCOMPLETE",
    "W_CODON_RAW_COUNT_PRIMARY",
    "W_UMI_SHORT_COLLISION_RISK",
    "W_UMI_PRESENT_BUT_SKIPPED",
    "W_PARALLEL_AUTO_OVERRIDDEN",
    "W_MANIFEST_SCHEMA_DRIFT",
]
...
E_FASTQ_MATE_PAIRING_FAILED = "E_FASTQ_MATE_PAIRING_FAILED"
E_ADAPTER_AMBIGUOUS = "E_ADAPTER_AMBIGUOUS"
E_UMI_DECLARED_BUT_NOT_FOUND = "E_UMI_DECLARED_BUT_NOT_FOUND"


# Per-read-length periodicity ---------------------------------------------

E_READ_LENGTH_NO_PERIODICITY = "E_READ_LENGTH_NO_PERIODICITY"


# RNA / Ribo pairing ------------------------------------------------------

E_RNA_RIBO_PAIRING_INCOMPLETE = "E_RNA_RIBO_PAIRING_INCOMPLETE"


# Soft warnings (W_*) — non-blocking, surfaced to warnings.tsv ------------

W_CODON_RAW_COUNT_PRIMARY = "W_CODON_RAW_COUNT_PRIMARY"
W_UMI_SHORT_COLLISION_RISK = "W_UMI_SHORT_COLLISION_RISK"
W_UMI_PRESENT_BUT_SKIPPED = "W_UMI_PRESENT_BUT_SKIPPED"
W_PARALLEL_AUTO_OVERRIDDEN = "W_PARALLEL_AUTO_OVERRIDDEN"
W_MANIFEST_SCHEMA_DRIFT = "W_MANIFEST_SCHEMA_DRIFT"
